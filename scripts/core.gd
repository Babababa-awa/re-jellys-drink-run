...
const MENU_LEVEL = &"apartment"
const START_LEVEL = &"apartment"

const TILE_SIZE = 32
const PHYSICS_TILE_SIZE = 16
...
const MENU_CAMERA_ZOOM: float = 4.0
const MENU_CAMERA_OFFSET: Vector2 = Vector2(0, -TILE_SIZE * 2.5)
const LEVEL_CAMERA_ZOOM: float = 4.0
const LEVEL_CAMERA_OFFSET: Vector2 = Vector2(0, -TILE_SIZE * 2.5)
